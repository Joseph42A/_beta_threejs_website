...
export function MainDraco(props) {
  const { nodes, materials } = useGLTF("/mainDraco.gltf");

  const { scale, rotation } = useControls("Model", {
    scale: 500,
    rotation: [-Math.PI / 2, 1.04, 0.9],
  });
    ...
    <group scale={5} {...props} dispose={null}>
      <group rotation={rotation}>
        ...
        <mesh
          ...
          material={materials.Mat}
        />
        <mesh geometry={nodes.MeshBody1.geometry} material={materials.Mat} />
        <mesh
...
useGLTF.preload("/mainDraco.gltf");
